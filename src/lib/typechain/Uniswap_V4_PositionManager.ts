...
export interface Uniswap_V4_PositionManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "WETH9"
...
export interface Uniswap_V4_PositionManager extends BaseContract {
  connect(runner?: ContractRunner | null): Uniswap_V4_PositionManager;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V4_PositionManagerInterface;
