...
export interface Uniswap_V4_PoolManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Uniswap_V4_PoolManager extends BaseContract {
  connect(runner?: ContractRunner | null): Uniswap_V4_PoolManager;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V4_PoolManagerInterface;
