...
import type {
  ...
  Uniswap_V4_PoolManagerInterface,
} from "../Uniswap_V4_PoolManager";
...
export class Uniswap_V4_PoolManager__factory {
  static readonly abi = _abi;
  static createInterface(): Uniswap_V4_PoolManagerInterface {
    return new Interface(_abi) as Uniswap_V4_PoolManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as Uniswap_V4_PoolManager;
  }
}
