...
import type {
  Uniswap_V4_PositionManager,
  Uniswap_V4_PositionManagerInterface,
} from "../Uniswap_V4_PositionManager";
...
export class Uniswap_V4_PositionManager__factory {
  static readonly abi = _abi;
  static createInterface(): Uniswap_V4_PositionManagerInterface {
    return new Interface(_abi) as Uniswap_V4_PositionManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as Uniswap_V4_PositionManager;
  }
}
