...
export interface Uniswap_V3_PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export namespace SetLmPoolEventEvent {
...
export namespace SwapEvent {
  export type InputTuple = [
    ...
    tick: BigNumberish,
    protocolFeesToken0: BigNumberish,
    protocolFeesToken1: BigNumberish
  ];
  export type OutputTuple = [
    sender: string,
    recipient: string,
...
export interface Uniswap_V3_Pool extends BaseContract {
  connect(runner?: ContractRunner | null): Uniswap_V3_Pool;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V3_PoolInterface;
  ...
  lmPool: TypedContractMethod<[], [string], "view">;
  ...
  setLmPool: TypedContractMethod<[_lmPool: AddressLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_lmPool: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    SetLmPoolEventEvent.InputTuple,
    SetLmPoolEventEvent.OutputTuple,
    SetLmPoolEventEvent.OutputObject
  >;
  getEvent(
    key: "Swap"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "SetFeeProtocol(uint32,uint32,uint32,uint32)": TypedContractEvent<
      SetFeeProtocolEvent.InputTuple,
      SetFeeProtocolEvent.OutputTuple,
      SetFeeProtocolEvent.OutputObject
    >;
    ...
    "SetLmPoolEvent(address)": TypedContractEvent<
      SetLmPoolEventEvent.InputTuple,
      SetLmPoolEventEvent.OutputTuple,
      SetLmPoolEventEvent.OutputObject
    >;
    SetLmPoolEvent: TypedContractEvent<
      SetLmPoolEventEvent.InputTuple,
      SetLmPoolEventEvent.OutputTuple,
      SetLmPoolEventEvent.OutputObject
    >;

    "Swap(address,address,int256,int256,uint160,uint128,int24,uint128,uint128)": TypedContractEvent<
      SwapEvent.InputTuple,
      SwapEvent.OutputTuple,
      SwapEvent.OutputObject
    >;
