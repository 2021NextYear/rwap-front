...
export interface Uniswap_V3_FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "collectProtocol"
      | "createPool"
...
export interface Uniswap_V3_Factory extends BaseContract {
  connect(runner?: ContractRunner | null): Uniswap_V3_Factory;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V3_FactoryInterface;
