...
export interface Uniswap_V3_NonfungiblePositionManagerInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
...
export interface Uniswap_V3_NonfungiblePositionManager extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): Uniswap_V3_NonfungiblePositionManager;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V3_NonfungiblePositionManagerInterface;
  ...
  pancakeV3MintCallback: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "pancakeV3MintCallback"
  ): TypedContractMethod<
    [amount0Owed: BigNumberish, amount1Owed: BigNumberish, data: BytesLike],
    [void],
    "nonpayable"
