...
export interface Uniswap_V4_StateViewInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getFeeGrowthGlobals"
      | "getFeeGrowthInside"
...
export interface Uniswap_V4_StateView extends BaseContract {
  connect(runner?: ContractRunner | null): Uniswap_V4_StateView;
  waitForDeployment(): Promise<this>;

  interface: Uniswap_V4_StateViewInterface;
